...
Revision ID: 24133a9348b5
Revises: 4d3d59461805
Create Date: 2024-03-03 14:13:42.156372
...
revision: str = '24133a9348b5'
down_revision: Union[str, None] = '4d3d59461805'
...
def upgrade() -> None:
    ...
    sa.Column('library', sa.ARRAY(sa.Integer()), nullable=True),
...
def downgrade() -> None:
    ...
    sa.Column('library', postgresql.ARRAY(sa.INTEGER()), autoincrement=False, nullable=True),
